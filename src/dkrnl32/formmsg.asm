...
FormatString proc uses ebx esi edi lpOut:ptr byte, lpFormat:ptr byte, pArguments:ptr, bIsWide:dword, nSize:dword, bArgsWide:dword, dwMax:dword
...
nocopy:                    
            ...
            .else
            	mov ecx, pArguments
                .if (!(ebx & FORMAT_MESSAGE_ARGUMENT_ARRAY))
                	mov ecx,[ecx]
                .endif
