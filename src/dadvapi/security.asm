...
GetSecurityInfo proc public handle:DWORD, OpjectType:DWORD, SecurityInfo:DWORD, ppsidOwner:ptr DWORD, ppsidGroup:ptr DWORD, ppDacl:ptr DWORD, ppSacl:ptr DWORD, ppSecurityDescriptor:ptr DWORD
...
DuplicateToken proc public hToken:DWORD, ImpersonationLevel:DWORD, pDuplicateToken

        xor eax, eax
		@strace <"DuplicateToken(", hToken, ", ", ImpersonationLevel, ", ", pDuplicateToken, ")=", eax, " *** unsupp ***">
        ret
        align 4
DuplicateToken endp
