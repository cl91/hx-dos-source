...
queue_empty:
        ...
        inc ecx
       	mov edx, esp
        invoke WaitForMultipleObjects, ecx, edx, 0, bWait
        mov esp, ebx
...
GetMessageA proc public pMsg:dword, hWnd:dword, dwMin:dword, dwMax:dword
		...
		@strace	<"GetMessageA(", pMsg, ", ", hWnd, ", ", dwMin, ", ", dwMax, ")">
...
WaitForInputIdle proc public hProcess:DWORD, dwMilliSeconds:DWORD
		xor eax, eax
		@strace <"WaitForInputIdle(", hProcess, ", ", dwMilliSeconds, ")=", eax>
		ret
        align 4
...
AttachThreadInput proc public idAttach:DWORD, idAttachTo:DWORD, fAttach:DWORD
		xor eax, eax
		@strace <"AttachThreadInput(", idAttach, ", ", idAttachTo, ", ", fAttach, ")=", eax>
		ret
        align 4
...
ReplyMessage proc public lResult:DWORD
		xor eax, eax
		@strace <"ReplyMessage(", lResult, ")=", eax>
		ret
        align 4
ReplyMessage endp
