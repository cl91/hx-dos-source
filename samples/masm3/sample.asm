...
;--- It will be linked with WIN32 emulation libraries DKRNL32S.LIB
;--- and DUSER32S.LIB, so a subset of Win32 API can be used here.
...
;--- either use win32 include files for MASM generated by h2incx.
